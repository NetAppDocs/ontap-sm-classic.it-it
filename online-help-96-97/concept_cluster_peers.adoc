...
. Nel campo *Immetti passphrase*, immettere una nuova passphrase, quindi fare clic su *Applica*.
+
[NOTE]
====
...
. Accedere al cluster remoto ed eseguire i passaggi <<STEP_52691237935644E3A8710F51CC2E3F81,1>> attraverso <<STEP_1ABAF15926174E709CA59192E200ABE3,4>> per modificare la passphrase nel cluster remoto.
+
...
+
** *Generare una passphrase*: Andare al passo <<STEP_1ABAF15926174E709CA59192E200ABE3,STEP_1ABAF15926174E709CA59192E200ABE3>>.
** *Avere già una passphrase*: Passare alla fase <<STEP_2EFD822431974811AD2260C3F31DC977,STEP_2EFD822431974811AD2260C3F31DC977>>.


. Se si seleziona *genera una passphrase*, completare i campi necessari:
+
** *IPSpace*: Selezionare IPSpace dal menu a discesa.
** *Passphrase Valid* (validità passphrase): Selezionare dal menu a discesa la durata per la quale si desidera che la passphrase sia valida.
** *Permessi SVM*: Selezionare una delle seguenti opzioni:
...
. Se è già stata generata una nuova passphrase nel cluster remoto, eseguire le seguenti operazioni secondarie:
+
...
. Accedere al cluster remoto ed eseguire i passaggi <<STEP_313E6AFE5C2B4D8C9E9723FAF1F8534A,1>> attraverso <<STEP_24E41EC7F4E746D09897FC2DCBEC0E18,3>> per eliminare la relazione peer tra il cluster locale e il cluster remoto.
+
