...
link:reference_application_provisioning_settings.md#GUID-00EAA47A-D310-4ED6-8D1B-7AE16AB3E6A5["Per le descrizioni dei campi, fare riferimento a Impostazioni di provisioning dell'applicazione"]
