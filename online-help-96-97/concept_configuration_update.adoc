...
... Se non si desidera utilizzare il valore predefinito, specificare un nuovo valore di destinazione. Se non esiste un percorso, viene creato automaticamente un nuovo percorso in base al gateway e alla destinazione.
