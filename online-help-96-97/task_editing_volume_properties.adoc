...
+
** Deduplica
** Compressione dei dati non è possibile attivare la compressione in background per un volume contenuto in un aggregato con All Flash Optimized Personality. È possibile attivare solo la compressione inline per questi volumi.
