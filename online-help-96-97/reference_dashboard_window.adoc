...
** I volumi hanno relazioni di protezione e non sono ancora inizializzati. È possibile accedere alla finestra Volumes (volumi) per visualizzare i volumi che non hanno una relazione di protezione definita.
