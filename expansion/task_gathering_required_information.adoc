...
** Se l'SP utilizza la configurazione di rete automatica, verificare che la subnet utilizzata dall'SP disponga di indirizzi IP disponibili per i due nuovi nodi utilizzando `network subnet show` comando. Nel seguente output, la subnet sub1 ha 2 indirizzi disponibili:
